                    ...
                    </div>
                    {
                        task === "cart"|| task=="payment"|| task=="address"|| task =="summary" ? <div></div> : <>
                            ...
                            <div className="rightNavbar">
                                ...
                                <div className="seller" onClick={()=>history.push("/supplierlogin")}>
