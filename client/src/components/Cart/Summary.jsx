...
export const Summary = ({ address }) => {
    ...
    const [deliveryDate,setDelveryDate] = useState(null)
    ...
    const getTodayDate = () => {
        ...
        let todayDate = {date:d,month:months[m],year:y}
        return todayDate
    }
    return (
        <>
            <div className="summary-container">
                ...
                <div className="summ-items" style={{ marginTop: "15px" }}>
                    <div style={{ color: "grey", display: "flex", gap: "15px", alignItems: "center", border: "1px solid grey", boxSizing: "border-box", padding: "5px" }}>
                        ...
                        <LocalShippingOutlinedIcon /> <b>Estimated Delivery by Saturday, {deliveryDate?deliveryDate.date+"th,"+ deliveryDate.month:""}</b>
